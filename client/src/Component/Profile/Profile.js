                                            ...
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    ...
                                                    {/* <div class="staff-msg"><a class="btn btn-custom"
                                                            href="https://smarthr.dreamguystech.com/html/template/chat.html">Send
                                                            Message</a></div> */}
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="project-title"><a
                                                href="https://smarthr.dreamguystech.com/html/template/project-view.html">Office
                                                Management</a></h4>
                                            ...
                                            <ul class="team-members">
                                                <li>
                                                    <a href="#" data-bs-toggle="tooltip" title="Jeffery Lalor"><img
                                                            alt=""
                                                            src="https://smarthr.dreamguystech.com/html/template/assets/img/profiles/avatar-16.jpg"/></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="project-members m-b-15">
                                            ...
                                            <ul class="team-members">
                                                <li>
                                                    <a href="#" data-bs-toggle="tooltip" title="John Doe"><img alt=""
                                                            src="https://smarthr.dreamguystech.com/html/template/assets/img/profiles/avatar-02.jpg"/></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-bs-toggle="tooltip" title="Richard Miles"><img
                                                            alt=""
                                                            src="https://smarthr.dreamguystech.com/html/template/assets/img/profiles/avatar-09.jpg"/></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-bs-toggle="tooltip" title="John Smith"><img alt=""
                                                            src="https://smarthr.dreamguystech.com/html/template/assets/img/profiles/avatar-10.jpg"/></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-bs-toggle="tooltip" title="Mike Litorus"><img
                                                            alt=""
                                                            src="https://smarthr.dreamguystech.com/html/template/assets/img/profiles/avatar-05.jpg"/></a>
                                                </li>
                                                <li>
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="project-title"><a
                                                href="https://smarthr.dreamguystech.com/html/template/project-view.html">Project
                                                Management</a></h4>
                                        <small class="block text-ellipsis m-b-15">
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="project-title"><a
                                                href="https://smarthr.dreamguystech.com/html/template/project-view.html">Video
                                                Calling App</a></h4>
                                        <small class="block text-ellipsis m-b-15">
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="project-title"><a
                                                href="https://smarthr.dreamguystech.com/html/template/project-view.html">Hospital
                                                Administration</a></h4>
                                        <small class="block text-ellipsis m-b-15">
